...
from models.kcbert_model import KcBERTSentimentModel
from models.kcelectra_model import KcELECTRASentimentModel
import plotly.graph_objects as go

class SentimentAnalysisApp:
    def __init__(self, data_dir=Path(__file__).parent / "data", model_dir=Path(__file__).parent / "e:/models"):
        ...
        self.models = {
            'KcBERT': {
                'model': KcBERTSentimentModel(
                    ...
                    model_dir=str(self.model_dir / "kcbert")
                ),
                'color': '#1f77b4'
            },
            'KcELECTRA': {
                'model': KcELECTRASentimentModel(
                    data_file=str(dataset_path),
                    model_dir=str(self.model_dir / "kcelectra")
                ),
                'color': '#ff7f0e'
            }
        }
